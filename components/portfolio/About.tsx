...
import { GithubIcon, LinkedinIcon, GraduationCap, MapPin, Code2, User } from "lucide-react";
...
export default function About() {
  ...
  return (
    <div id="about" ref={sectionRef} className="relative py-24 px-6 bg-base-100">
      <div className="relative z-10 max-w-5xl mx-auto">
        <div className="animate-on-scroll text-center mb-14">
          <p className="code-comment mb-2">{"// get to know me"}</p>
            ...
            <div className="terminal-card h-full">
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-5">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-base-content/40 font-mono flex items-center gap-1">
                      <MapPin className="w-3 h-3" /> Dracut, MA
                    </p>
                  </div>
                </div>
                ...
                <p className="text-sm text-base-content/50 leading-relaxed mb-6">
                  ...
                  integrations, and AWS architectures with WCAG 2.1 AA standards.
                </p>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      >
                        <div className="w-1 h-8 bg-gradient-to-b from-primary to-secondary rounded-full flex-shrink-0" />
